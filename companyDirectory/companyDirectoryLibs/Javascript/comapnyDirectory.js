        ...
        $.ajax({
            ...
            success: function(result){
                ...
                for(let i = 0; i < departmentData.length; i++){
                    ...
                    $('#departmentTable').append("<tr id='"+departmentId+"'><td class='departmentId'>"+departmentId+"</td><td class='departmentName'>"+depName+"</td><td class='departmentLocation'>"+departmentLocation+"</td><td><button class='deleteDepartment' title='Delete Department' data-toggle='modal' data-target='#deleteDepartmentModal' onclick='deleteDepartment(this)' type='button'><i class='bi bi-trash-fill'></i></button><button title='Edit Department' class='editDepartmentButton' data-toggle='modal' data-target='#editDepartmentModal' onclick='selectDepartmentEdit(this)'><i class='bi bi-pencil-square'></i></button></td></tr>");
                }
                ...
                $.ajax({
                    ...
                    success: function(result){
                        ...
                        for(let i = 0; i < locationData.length; i++){
                            ...
                            $('#locationTable').append("<tr departmentTableId='"+locId+"'><td class='locationId'>"+locId+"</td><td class='locationName'>"+locName+"</td><td><button class='deleteLocation' title='Delete Location' data-toggle='modal' data-target='#deleteLocationModal' onclick='deleteLocation(this)' type='button'><i class='bi bi-trash-fill'></i></button></td></tr>");
                        }
                    }
                });
            }
...
function deleteDepartment(ctl){
    ...
    $('#departmentDeleteBody').append("<p>Are you sure you want to <strong>DELETE</strong> Department <strong>" + nameDepartment + "</strong>?</p><br><p>Deleting this department will <strong>DELETE ALL EMPLOYEES</strong> in <strong>" + nameDepartment + "</strong></p>");
...
function deleteLocation(ctl){
    ...
    $('#locationDeleteBody').append("<p>Are you sure you want to <strong>DELETE</strong> Location <strong>" + nameLocation + "</strong>?</p><br><p>Deleting this Location will <strong>DELETE ALL EMPLOYEES & DEPARTMENTS</strong> in <strong>" + nameLocation + "</strong></p>");
