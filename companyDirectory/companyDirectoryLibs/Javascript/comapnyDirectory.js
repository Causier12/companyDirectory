...
function deleteDepartment(ctl){
    ...
    $('#departmentDeleteBody').append("<p>Are you sure you want to <strong>DELETE</strong> Department <strong>" + nameDepartment + "</strong>?</p>");
    document.getElementById('deleteDepartmentButton').onclick = function() {
        $.ajax({
            ...
            success: function(response){
                ...
                if(dependencies === 0){
                    $('#finalDeletePromptModal').modal('show');
...
function deleteLocation(ctl){
    ...
    $('#locationDeleteBody').append("<p>Are you sure you want to <strong>DELETE</strong> Location <strong>" + nameLocation + "</strong>?</p>");
